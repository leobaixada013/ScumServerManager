...
class FileManager {
    ...
    async validateDiscordWebhook(webhookUrl) {
        try {
            if (!webhookUrl || !webhookUrl.includes('discord.com/api/webhooks/')) {
    ...
    async sendDiscordMessageWithFallback(primaryWebhook, message, fallbackWebhooks = []) {
